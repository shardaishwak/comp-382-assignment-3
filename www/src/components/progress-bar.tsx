    ...
    <div className="w-full">
      <div className="flex h-2 rounded-full overflow-hidden divide-x divide-border-light">
        <div className="flex-1 bg-border-normal overflow-hidden">
          <div className="h-full bg-[#86dee472] rounded-l-full float-right duration-500 ease-out" style={{ width: `${bottom}%` }}></div>
        </div>
        <div className="flex-1 bg-border-normal overflow-hidden">
          <div className="h-full bg-[#e4869377] rounded-r-full duration-500 ease-out" style={{ width: `${top}%` }}></div>
        </div>
      </div>
