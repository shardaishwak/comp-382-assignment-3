...
export default function TrayArea({ dominos }: { dominos: DominoType[] }) {
  return (
    <div className="w-full lg:w-auto flex flex-col">
      ...
      <div className="w-full min-h-24 p-2 flex flex-row lg:flex-col gap-2 overflow-x-scroll lg:overflow-y-scroll border border-b-4 border-mist-300 rounded-xl rounded-tl-none duration-150">
