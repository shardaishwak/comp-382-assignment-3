...
export default function Domino({ id, top, bottom, isHint = false }: Domino & { isHint?: boolean }) {
  return (
    <div className={`min-w-20 min-h-28 rounded-xl p-2 grid grid-rows-2 divide-y divide-solid  border border-b-4 hover:-translate-y-2 duration-150 ${isHint ? "bg-[#0f1e21] divide-[#1b292c] border-[#447d8a]" : "bg-background2 divide-border-muted border-border-normal"}`}>
